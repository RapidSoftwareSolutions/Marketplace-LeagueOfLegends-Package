<?php
$app->post('/api/LeagueOfLegends/getChampionDataById', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'region', 'championId']);
    ...
    $query_str = 'https://'.$post_data['args']['region'].$settings['api_url']."lol/static-data/v3/champions/".$post_data['args']['championId'];
    $body = array();
