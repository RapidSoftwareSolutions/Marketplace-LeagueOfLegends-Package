<?php
$app->post('/api/LeagueOfLegends/getSummonerSpellById', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'region', 'summonerSpellId']);
    ...
    $query_str = 'https://' . $post_data['args']['region'] . $settings['api_url'] . "lol/static-data/v3/summoner-spells/".$post_data['args']['summonerSpellId'];
    $body = array();
