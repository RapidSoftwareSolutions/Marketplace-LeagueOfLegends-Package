<?php
$app->post('/api/LeagueOfLegends/getItemById', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'region', 'itemId']);
    ...
    $query_str = 'https://' . $post_data['args']['region'] . $settings['api_url'] . "lol/static-data/v3/items/" . $post_data['args']['itemId'];
    $body = array();
