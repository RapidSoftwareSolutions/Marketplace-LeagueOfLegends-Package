<?php
$app->post('/api/LeagueOfLegends/getRuneById', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'region', 'runeId']);
    ...
    $query_str = 'https://' . $post_data['args']['region'] . $settings['api_url'] . "lol/static-data/v3/runes/".$post_data['args']['runeId'];
    $body = array();
