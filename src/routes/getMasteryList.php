<?php
$app->post('/api/LeagueOfLegends/getMasteryList', function ($request, $response, $args) {
    ...
    $query_str = 'https://' . $post_data['args']['region'] . $settings['api_url'] . "lol/static-data/v3/masteries";
    $body = array();
