<?php
$app->post('/api/LeagueOfLegends/getChampionList', function ($request, $response, $args) {
    ...
    $query_str = 'https://' . $post_data['args']['region'] . $settings['api_url'] . "lol/static-data/v3/champions";
    $body = array();
